...
import { buildDetailQuantitySnapshot } from './settlement-rules.mjs'
...
export const planPool = [
    ...
    subPlans: [
      {
        ...
        transportTotal: 30, settledQty: 0, unsettledQty: 30, currentSettleQty: 30,
        lineItems: [{ id: 'l1-1', name: '电子产品', transportTotal: 30, settledQty: 0, unsettledQty: 30, currentSettleQty: 30, unitPrice: null, subsidyAmount: 0, deductionAmount: 0, subsidyItems: [], deductionItems: [] }],
      },
      {
        seq: 2, transportMode: '水路', from: '上海港', to: '广州港',
        billingCondition: '按集装箱', billingBasis: '', unitPrice: 4500, priceUnit: '元/箱',
        transportTotal: 15, settledQty: 0, unsettledQty: 15, currentSettleQty: 15,
        lineItems: [{ id: 'l2-1', name: '20GP', transportTotal: 10, settledQty: 0, unsettledQty: 10, currentSettleQty: 10, unitPrice: 4500, subsidyAmount: 0, deductionAmount: 0, subsidyItems: [], deductionItems: [] }, { id: 'l2-2', name: '40HQ', transportTotal: 5, settledQty: 0, unsettledQty: 5, currentSettleQty: 5, unitPrice: 4800, subsidyAmount: 0, deductionAmount: 0, subsidyItems: [], deductionItems: [] }],
      },
      {
        seq: 3, transportMode: '公路', from: '广州港', to: '广州仓库',
        billingCondition: '按重量', billingBasis: '按卸货口径', unitPrice: 60, priceUnit: '元/吨',
        transportTotal: 29.5, settledQty: 0, unsettledQty: 29.5, currentSettleQty: 29.5,
        lineItems: [{ id: 'l3-1', name: '电子产品', transportTotal: 29.5, settledQty: 0, unsettledQty: 29.5, currentSettleQty: 29.5, unitPrice: null, subsidyAmount: 0, deductionAmount: 0, subsidyItems: [], deductionItems: [] }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    partyId: 'SP001',
    route: '杭州 → 宁波',
    cargoSummary: '化工原料 20吨',
    billingCondition: '按重量', billingBasis: '按装货口径', billingUnit: '元/吨',
    unitPrice: 110,
    selectable: false,
    unselectableReason: '缺少首段装货确认量',
    cargoItems: [
      { id: 'c1', name: '化工原料', transportTotal: 0, settledQty: 0, unsettledQty: 0 },
    ],
  },
]
  ...
  plans: [
    {
      ...
      items: [
        { id: 'i1', name: '机械设备', transportTotal: 30, ...buildDetailQuantitySnapshot(30, 0, 30), settleQty: 30, unitPrice: 100, baseFee: 3000, subsidy: 0, deduction: 0, checkFee: 3000, subsidyItems: [], deductionItems: [] },
        { id: 'i2', name: '木材', transportTotal: 20, ...buildDetailQuantitySnapshot(20, 0, 20), settleQty: 20, unitPrice: 100, baseFee: 2000, subsidy: 0, deduction: 0, checkFee: 2000, subsidyItems: [], deductionItems: [] },
      ],
      ...
      subPlans: [
        {
          seq: 1, transportMode: '公路', from: '苏州', to: '上海港',
          billingCondition: '按重量', billingBasis: '按装货口径', unitPrice: 80, priceUnit: '元/吨',
          lineItems: [{ name: '电子产品', transportTotal: 30, ...buildDetailQuantitySnapshot(30, 0, 30), currentSettleQty: 30, unitPrice: null, lineFee: 2400, subsidy: 1000, deduction: 500, subsidyItems: [{ name: '装车补贴', amount: 1000 }], deductionItems: [{ name: '晚到扣款', amount: 500 }] }],
        ...
        },
        {
          ...
          billingCondition: '按集装箱', billingBasis: '', unitPrice: 4500, priceUnit: '元/箱',
          lineItems: [
            { name: '20GP', transportTotal: 10, ...buildDetailQuantitySnapshot(10, 0, 10), currentSettleQty: 10, unitPrice: 4500, lineFee: 45000, subsidy: 1000, deduction: 500, subsidyItems: [{ name: '港杂补贴', amount: 1000 }], deductionItems: [{ name: '堆存扣款', amount: 500 }] },
            { name: '40HQ', transportTotal: 5, ...buildDetailQuantitySnapshot(5, 0, 5), currentSettleQty: 5, unitPrice: 4800, lineFee: 24000, subsidy: 0, deduction: 0, subsidyItems: [], deductionItems: [] },
          ],
        ...
        },
        {
          seq: 3, transportMode: '公路', from: '广州港', to: '广州仓库',
          billingCondition: '按重量', billingBasis: '按卸货口径', unitPrice: 60, priceUnit: '元/吨',
          lineItems: [{ name: '电子产品', transportTotal: 29.5, ...buildDetailQuantitySnapshot(29.5, 0, 29.5), currentSettleQty: 29.5, unitPrice: null, lineFee: 1770, subsidy: 0, deduction: 0, subsidyItems: [], deductionItems: [] }],
